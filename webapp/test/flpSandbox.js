		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "StaffingApp",
									"targetURL": "#ui5staffingapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5staffingapp-display": {
								"semanticObject": "ui5staffingapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5staffingapp",
									"url": sap.ui.require.toUrl("ui5staffingapp")
								}
							}
						}
					}
